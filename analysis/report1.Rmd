...
"All the Talent Migration metrics are based on net migration (arrivals minus departures)."
[3](https://datacatalog.worldbank.org/dataset/talent-migration-linkedin-data) 
...
- If we see the median, the growth of financial and insurance activities showed the highest growth, while mining and quarrying industry showed the slowest growth.
...
- The two highest net migration rates also exist in financial and insurance activities: Venture Capital & Private Equity (about 272) and Capital Markets (about 186).
...
- There is no obvious linear relationship between industry growth rate and migration rate.

- Although the migration rate of most industries has increased, the industry growth rate in most industries has not changed.
